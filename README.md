...
Most of the source codes of this project, `advent-of-code-2020` are stored in the `advent_of_code_2020` directory.
...
`make create-container` creates and launch the advent_of_code_2020 container.
